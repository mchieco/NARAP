    ...
    <div style="padding-bottom: 15px; padding-left: 20px;" class="row">
      <div class="col-md-6 col-sm-12 col-lg-6">
        <div class="row">
          ...
          <v-btn @click="showModal(mammogramObject1,'Have you been told by a health professional that you no longer need to have mammograms for breast cancer screenings?')" small rounded color="success">View Graph</v-btn>
        </div>
      ...
      <div class="col-md-6 col-sm-12 col-lg-6">
        <div class="row">
            ...
            <v-btn @click="showModal(mammogramObject2, 'Have you been told by a health professional that you need a mammogram more often than every two years?')" small rounded color="success">View Graph</v-btn>
            </div>
    ...
    <div style="padding-bottom: 15px; padding-left: 20px;" class="row">
      <div class="col-md-6 col-sm-12 col-lg-6">
        <div class="row">
          ...
          <v-btn @click="showModal(mammogramObject3,'Have you  had a mammogram within the last two years?')" small rounded color="success">View Graph</v-btn>
        </div>
