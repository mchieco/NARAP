  ...
  <div>
    ...
    <div style="padding-bottom: 15px;" class="row">
      <div class="col-md-4 col-sm-12 col-lg-4">
        <div class="row">
          <h2>Primary Care Practitioner</h2>
...
export default {
  ...
  methods: {
    async load() {
      ...
      this.primaryObject = {
        'Does not have primary care practitioner': this.pcpno = x.pcpno,
        'Does have primary practitioner': this.pcpyes,
        'Does not know if they have a primary care practitioner': this.pcpIDK,
        'Has not had pimary practitioner visit within preceding 12 months': this.pcp12monthsno,
        'Does not know if they had pimary practitioner visit within preceding 12 months': this.pcp12monthsIDK,
        'Has had pimary practitioner visit within preceding 12 months': this.pcpbothyes,
        'Have a primary care practitioner and is up to date': this.pcpyesvisitno,
        'Have a primary care practitioner and is not up to date': this.pcpnovisityes,
        'Does not have a primary care practitioner but is up to date with visits': this.pcpbothno,
        'Does not have a primary care practitioner and is not up to date with visits': this.pcpintervention,
