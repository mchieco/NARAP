    ...
    <div class>
      ...
      <v-row class="columnText">
        ...
        <v-col cols="6">
          ...
          <h5
            class="titleHeader"
          >NARAP has selected and completed the implementation of DonorPerfect as the organization’s first Customer Relationship Management (CRM) System.  The CRM system will be used by NARAP volunteers to build relationships with a variety of key stakeholders, including Affiliate Hospitals, Clinical Research Partners, Corporate and Private Grant Providers, Major Gift Donors, and more.</h5>
        </v-col>
        <hr class="new5" />
      </v-row>
